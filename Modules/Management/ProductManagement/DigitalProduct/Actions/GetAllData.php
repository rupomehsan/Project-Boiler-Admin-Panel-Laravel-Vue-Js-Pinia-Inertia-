...
class GetAllData
{
    ...
    $q->where('category_id', 'like', '%' . $searchKey . '%');    
    ...
    $q->orWhere('regular_price', 'like', '%' . $searchKey . '%');    

    $q->orWhere('sale_price', 'like', '%' . $searchKey . '%');    

    $q->orWhere('demo_url', 'like', '%' . $searchKey . '%');    

    $q->orWhere('file_path', 'like', '%' . $searchKey . '%');    

    $q->orWhere('file_type', 'like', '%' . $searchKey . '%');    

    $q->orWhere('version', 'like', '%' . $searchKey . '%');    

    $q->orWhere('thumbnail_image', 'like', '%' . $searchKey . '%');    

    $q->orWhere('gallery_images', 'like', '%' . $searchKey . '%');    
