/**
 * DigitalProduct Store - Factory Pattern Implementation
 *
 ...
 * @package DigitalProduct
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the DigitalProduct store with all CRUD functionality
export const digital_product_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = digital_product_store;

// Default export for Composition API usage
export default digital_product_store;
