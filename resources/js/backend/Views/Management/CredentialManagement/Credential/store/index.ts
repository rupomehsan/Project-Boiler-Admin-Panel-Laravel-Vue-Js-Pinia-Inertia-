/**
 * Credential Store - Factory Pattern Implementation
 *
...
// Create the Credential store with all CRUD functionality
export const credential_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = credential_store;

// Default export for Composition API usage
export default credential_store;
