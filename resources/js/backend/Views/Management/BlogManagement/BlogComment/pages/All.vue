        ...
        <div class="card">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-12 col-md-3 mb-2 mb-md-0">
                <h5 class="mb-0" style="font-size: 0.95rem; font-weight: 700">
                  <i class="fa fa-comments mr-2" style="color: #0d6efd"></i>All
                  Blog Comments
                </h5>
              </div>
              ...
              <!-- Blog Filter Dropdown (Task 2) -->
              <div class="col-12 col-md-3 mb-2 mb-md-0">
                <select
                  class="form-control form-control-sm"
                  v-model="selected_blog_id"
                  @change="on_blog_filter"
                >
              ...
              >
                ...
                <!-- Blog Wise Comments button (Task 3) -->
              </div>
            </div>
          </div>
          ...
          <div class="card-body p-0">
            ...
            <div v-if="loading" class="text-center py-5">
              <i class="fa fa-spinner fa-spin fa-2x" style="color: #0d6efd"></i>
                ...
                <tbody v-if="comments.length">
                  ...
                  >
                    ...
                    <tr>
                      ...
                      >
                        <div v-html="truncate(comment.comment, 30)"></div>
                      </td>
                      <td :title="comment.blog ? comment.blog.title : ''">
                        {{
                          truncate(
                            comment.blog
                              ? comment.blog.title
                              : String(comment.blog_id),
                            50,
                          )
                        }}
                      </td>
                    ...
                    <td colspan="7">
                      <div class="d-flex flex-column align-items-center py-5">
                        ...
                        <p class="text-secondary">
                          Try adjusting your search or blog filter.
                        </p>
                      </div>
                    </td>
                  </tr>
...
export default {
  ...
  methods: {
    async load_blogs() {
      try {
        const res = await axios.get(`${this.api_base}/blogs`, {
          params: { get_all: 1, limit: 200 },
        });
        if (res.data?.data) {
          this.blogs = Array.isArray(res.data.data)
            ? res.data.data
            : res.data.data.data || [];
        }
      } catch (_) {}
    ...
    async load_comments() {
      this.loading = true;
      try {
        let url = this.selected_blog_id
          ? `${this.api_base}/blog-comments/blog/${this.selected_blog_id}`
          : `${this.api_base}/blog-comments`;
    ...
    async submit_reply(comment_id) {
      ...
      try {
        ...
        const res = await axios.post(
          `${this.api_base}/blog-comment-replies/store`,
          payload,
        );
        ...
        if (e.response?.data?.errors) {
          ...
          this.reply_error = Object.values(errs).flat().join(" ");
        } else {
          window.s_warning &&
    ...
    go_to_replies(comment) {
      this.$router.push({
        ...
        query: {
          preview: this.strip_html(comment.comment).substring(0, 120),
