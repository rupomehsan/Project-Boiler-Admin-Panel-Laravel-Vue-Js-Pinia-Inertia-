        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="d-flex align-items-center flex-wrap" style="gap:10px;">
                  ...
                  <span
                    ...
                    style="
                      ...
                      background:#e8f4fd;border:1px solid #bee5f5;
                      font-size:0.8rem;font-weight:600;color:#0c6f9f;
                    "
                  >
              ...
              <div class="col-12 col-md-6 text-md-right d-flex justify-content-end" style="gap:6px;">
                <button
          ...
          <div class="card-body" style="border-bottom:1px solid #dee2e6;">
            <h6 style="font-size:0.88rem;font-weight:600;margin-bottom:10px;">
              <i class="fa fa-plus-circle mr-1" style="color:#0d6efd;"></i>Add New Reply
            </h6>
            <div class="mb-2">
              <input
            ...
            <div class="mb-2">
              ...
              ></textarea>
              <small v-if="new_reply_error" class="text-danger" style="font-size:0.8rem;">
                {{ new_reply_error }}
              </small>
            </div>
            <button
                      ...
                      <div class="d-flex flex-column align-items-center py-5">
                        <div
                          style="width:100px;height:100px;display:flex;align-items:center;justify-content:center;
                                 background:linear-gradient(135deg,#667eea,#764ba2);border-radius:12px;opacity:0.55;"
                        >
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap" style="gap:8px;">
              ...
              <div v-if="pagination.last_page > 1" class="d-flex flex-wrap" style="gap:4px;">
                <button
                  ...
                  :style="pagination.current_page === 1
...
export default {
  ...
  methods: {
    async load_replies() {
      ...
      try {
        const res = await axios.get(
          `${this.api_base}/blog-comment-replies/${this.comment_id}`,
    ...
    async submit_new_reply() {
      ...
      try {
        const payload = {
          blog_comment_id: this.comment_id,
          comment: JSON.stringify(text),
        };
        if (this.new_reply_name.trim()) payload.name = this.new_reply_name.trim();

        const res = await axios.post(`${this.api_base}/blog-comment-replies/store`, payload);
        ...
        if (e.response?.data?.errors) {
          ...
          this.new_reply_error = Object.values(errs).flat().join(" ");
        } else {
          window.s_warning && window.s_warning("An error occurred. Please try again.");
        }
      } finally {
