/**
 * BlogTag Store - Factory Pattern Implementation
 *
...
// Create the BlogTag store with all CRUD functionality
export const blog_tag_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = blog_tag_store;

// Default export for Composition API usage
export default blog_tag_store;
