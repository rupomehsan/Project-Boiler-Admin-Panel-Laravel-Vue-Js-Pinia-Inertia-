/**
 * Blog Store - Factory Pattern Implementation
 *
...
// Create the Blog store with all CRUD functionality
export const blog_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = blog_store;
