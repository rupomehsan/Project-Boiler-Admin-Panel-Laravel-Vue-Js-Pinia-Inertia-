/**
 * BlogWriter Store - Factory Pattern Implementation
 *
...
// Create the BlogWriter store with all CRUD functionality
export const blog_writer_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = blog_writer_store;

// Default export for Composition API usage
export default blog_writer_store;
