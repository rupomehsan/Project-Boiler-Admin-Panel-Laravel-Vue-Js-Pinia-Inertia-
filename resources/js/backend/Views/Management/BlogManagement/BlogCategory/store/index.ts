/**
 * BlogCategory Store - Factory Pattern Implementation
 *
...
// Create the BlogCategory store with all CRUD functionality
export const blog_category_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = blog_category_store;

// Default export for Composition API usage
export default blog_category_store;
