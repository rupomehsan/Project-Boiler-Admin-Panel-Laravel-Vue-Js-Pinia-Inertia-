      ...
      <div class="col-sm-12">
        <div class="card">
            ...
            <div class="row align-items-center">
              <div class="col-12 col-md-5 mb-2 mb-md-0">
                <h5 class="mb-0" style="font-size: 0.95rem; font-weight: 700">
                  <i class="fa fa-comments-o mr-2" style="color: #6f42c1"></i
                  >Project Wise Comments
                </h5>
              </div>
          ...
          <div
            ...
            "
          >
            <strong>Project:</strong> {{ selected_project.name }}
            <span class="ml-3">
          ...
          <div class="card-body p-0">
            ...
            >
              ...
              <h5 class="text-muted mt-3">Select a Project</h5>
              <p class="text-secondary">
                Choose a project from the dropdown to view its comments.
              </p>
            </div>
                          ...
                          >
                            ...
                            <em style="color: #333"
                              >"{{
                                ...
                                comment.comment &&
                                comment.comment.replace(/<[^>]*>/g, "").length >
                                  100
                                  ? "..."
                                  : ""
                              }}"</em
          ...
          <!-- Pagination -->
          <div class="card-footer py-2" v-if="selected_project_id && !loading">
            <div
  ...
  methods: {
    ...
    on_project_select() {
      ...
      this.selected_project =
        this.projects.find((p) => p.id == this.selected_project_id) || null;
    ...
    async load_comments() {
      if (!this.selected_project_id) return;
      this.loading = true;
      try {
      ...
      this.$router.push({
        ...
        query: {
          preview: comment.comment
            ? comment.comment.replace(/<[^>]*>/g, "").substring(0, 120)
            : "",
