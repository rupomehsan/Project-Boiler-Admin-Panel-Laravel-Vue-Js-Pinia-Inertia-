/**
 * Project Store - Factory Pattern Implementation
 *
...
// Create the Project store with all CRUD functionality
export const project_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = project_store;
